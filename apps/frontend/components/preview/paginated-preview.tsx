    ...
    <div className="flex flex-col h-full overflow-hidden">
      ...
      <div className="flex items-center justify-between px-4 py-2 border-b border-steel-grey bg-secondary shrink-0">
        <div className="flex items-center gap-2">
          ...
          <span className=" text-xs w-12 text-center text-ink-soft">
            {Math.round(zoom * 100)}%
          </span>
          <Button
            variant="ghost"
          ...
          >
            ...
            <span className=" text-xs uppercase">{t('preview.margins')}</span>
          </Button>
        </div>
            ...
            <React.Fragment key={page.pageNumber}>
              {index > 0 && (
                <div className="flex items-center gap-2 py-2">
                  ...
                  <span className=" text-[10px] text-steel-grey uppercase tracking-wider">
                    {t('preview.pageBreak')}
                  </span>
                  <div className="h-px w-8 bg-steel-grey" />
                </div>
