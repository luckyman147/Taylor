  ...
  return (
    <div className="fixed inset-0 z-50">
      ...
      <div className="fixed inset-0 flex items-center justify-center p-4">
        <div
          className="relative w-full max-w-md border border-[#e6e3dc] bg-white shadow-lg p-6"
        ...
        >
          ...
          {/* Title */}
          <h3 className=" text-xs uppercase tracking-wider mb-4 text-ink-soft">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-2">
              <Label htmlFor="link-text" className=" text-xs uppercase tracking-wider">
                Display Text
              </Label>
              <Input
                id="link-text"
