  ...
  if (!isMounted) {
    return (
      <div className={cn('space-y-1', className)}>
        <div className="flex items-center gap-1 p-1 border border-ink bg-secondary h-9" />
        <div
          className={cn(
            'w-full border border-ink bg-white',
            'px-3 py-2 text-sm text-steel-grey rounded-lg'
          )}
          style={{ minHeight }}
        >
          {placeholder}
  ...
  return (
    <div className={cn('space-y-1', className)}>
      ...
      <div
        className={cn(
          'w-full border border-ink bg-white',
          'px-3 py-2 text-sm text-black rounded-lg',
