  ...
  return (
    <div className="relative text-sm">
      <button
        ...
        className="inline-flex items-center gap-2 rounded-lg border border-ink bg-white px-3 py-2 text-black shadow-sw-sm transition-all hover:translate-x-[1px] hover:translate-y-[1px] hover:shadow-none"
      >
        <span className="font-semibold">{t('settings.apiKeyMenu.buttonLabel')}</span>
        <span className=" text-xs text-ink-soft">{maskedKey}</span>
      ...
      {isOpen ? (
        <>
          <div
            ...
            aria-hidden="true"
          />
          <div className="absolute right-0 z-50 mt-2 w-80 rounded-lg border border-ink bg-white p-4 shadow-sw-default">
            ...
            <input
              ...
              className="mt-1 w-full rounded-lg border border-ink bg-background px-3 py-2 text-sm text-black focus:border-primary focus:outline-none focus:ring-1 focus:ring-primary"
            />
            ...
            <div className="mt-4 flex items-center justify-between gap-2">
              <button
                type="button"
                onClick={handleClose}
                className="rounded-lg border border-ink px-3 py-2 text-xs font-semibold text-black hover:bg-background"
              >
                {t('common.cancel')}
              </button>
              <button
                ...
                className={`rounded-lg border border-ink px-4 py-2 text-xs font-semibold transition-all ${
                  status === 'saving'
                    ? 'bg-steel-grey text-ink-soft cursor-wait'
                    : 'bg-primary text-white shadow-sw-sm hover:translate-x-[1px] hover:translate-y-[1px] hover:shadow-none'
                }`}
              >
