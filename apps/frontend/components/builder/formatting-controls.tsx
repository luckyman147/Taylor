...
export const FormattingControls: React.FC<FormattingControlsProps> = ({ settings, onChange }) => {
  ...
  return (
    <div className="overflow-hidden rounded-2xl border border-[#e6e3dc] bg-white shadow-sw-xs">
      ...
      {/* Expandable Content */}
      {isExpanded && (
        <div className="border-t border-[#e6e3dc] p-4 space-y-6 md:p-5">
          {/* Template Selection */}
          <div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-2">
                ...
                <div className="flex gap-1">
                  {(['serif', 'sans-serif', 'mono', 'times-roman'] as HeaderFontFamily[]).map(
                    (font) => (
                      <button
                        key={font}
              ...
              <div className="flex items-center gap-2">
                ...
                <div className="flex gap-1">
                  {(['serif', 'sans-serif', 'mono', 'times-roman'] as BodyFontFamily[]).map(
                    (font) => (
                      <button
                        key={font}
            ...
            <div className="space-y-3">
              ...
              <label className="flex cursor-pointer items-center gap-3">
                <button
                  type="button"
                  role="switch"
                  aria-checked={settings.showContactIcons}
                ...
                >
                  <span
                    className={`absolute top-0.5 h-5 w-5 rounded-full bg-white shadow-sw-xs transition-all ${
                      settings.showContactIcons ? 'left-[22px]' : 'left-0.5'
                    }`}
                  />
                </button>
                <span className=" text-xs text-ink-soft">
