...
export const SwissGrid = ({ children }: { children: React.ReactNode }) => {
  ...
  return (
    ...
    >
      ...
      <div className="w-full max-w-[86rem] max-h-full border border-ink bg-background shadow-sw-lg flex flex-col overflow-hidden">
        {/* Header Section - stays above hovered cards */}
        <div className="border-b border-ink p-8 md:p-12 shrink-0 bg-background relative z-30">
          <h1 className="font-serif text-5xl md:text-7xl text-black tracking-tight leading-[0.95] uppercase">
            {t('nav.dashboard')}
          </h1>
          <p className="mt-6 text-sm  text-primary uppercase tracking-wide max-w-md font-bold">
            {'// '}
        ...
        <div className="@container flex-1 overflow-y-auto overflow-x-hidden relative z-10">
          <div className="p-[1.5px]">
            <div className="grid grid-cols-1 @2xl:grid-cols-2 @3xl:grid-cols-3 @5xl:grid-cols-5 bg-black gap-[1px] border-b border-ink">
              {children}
            </div>
          </div>
        </div>
        ...
        <div className="p-4 bg-background flex justify-between items-center  text-xs text-primary border-t border-ink shrink-0 relative z-30">
          ...
          <div className="flex items-center gap-4">
            <Link
              href="/tracker"
              className="inline-flex items-center justify-center gap-2 bg-background text-black border border-ink px-6 py-2 uppercase font-bold tracking-wide shadow-sw-sm hover:translate-y-[1px] hover:translate-x-[1px] hover:shadow-none transition-all min-w-[140px] text-center"
            >
            ...
            <Link
              href="/settings"
              className="bg-warning text-black border border-ink px-6 py-2 uppercase font-bold tracking-wide shadow-sw-sm hover:translate-y-[1px] hover:translate-x-[1px] hover:shadow-none transition-all min-w-[140px] text-center"
            >
              {t('nav.settings')}
            </Link>
          </div>
